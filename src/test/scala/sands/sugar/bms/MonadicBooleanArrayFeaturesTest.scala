...
class MonadicBooleanArrayFeaturesTest extends AnyFlatSpec with Matchers {
  ...
  import sands.sugar.bms.typeclass.functions.BooleanFunctions.ArrayAsMonad.arrayMonadicBooleanFunctions // required only for Monadic functions. Zipping ones are by default
